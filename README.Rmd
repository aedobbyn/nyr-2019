...
This talk was given at [NYR 2019](https://www.rstats.nyc/). The [original talk](https://aedobbyn.github.io/nyc-fires/index.html) (even more `drake` !! + some live coding) was given at [RLadies NYC](https://www.rladiesnyc.org/). [Repo here](https://github.com/aedobbyn/nyc-fires).
